...
const Login = () => {
  ...
  return (
    <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center '>
          ...
          <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex relative' onClick={(e)=>e.preventDefault()}>
             < FaLongArrowAltLeft className='absolute top-[16%]  left-[5%]  w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
                {/* left div */}
                ...
                <div className='w-[50%] h-[100%] rounded-r-2xl bg-[black] md:flex items-center justify-center flex-col hidden'>
                  ...
                  <span className='text-2xl'>VIRTUAL COURSES</span>
