      ...
      <div className='bg-white shadow-xl rounded-xl w-full max-w-2xl p-6'>
        ...
        <input type='text' className='w-full border border-gray-300 rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-black mb-4' placeholder='e.g. Introduction to Mern Stack' onChange={(e)=>setLectureTitle(e.target.value)} value={lectureTitle}/>
          ...
          <div className='flex gap-4 mb-6'>
            <button className='flex items-center gap-2 px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 text-sm font-medium' onClick={()=>navigate(`/editcourse/${courseId}`)}><FaLongArrowAltLeft/>Back to Course</button>
