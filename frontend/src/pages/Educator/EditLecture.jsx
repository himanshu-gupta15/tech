  ...
  return (
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
      ...
      <div className='flex items-center gap-2 mb-2'>
        <FaLongArrowAltLeft className='text-gray-600 cursor-pointer' onClick={()=>navigate(`/createlecture/${courseId}`)}/>
      ...
      <div className='space-y-4'>
        ...
        <div>
          ...
          <input type="file" className='w-full p-2 border border-gray-300 rounded-md text-sm focus:ring-2 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-gray-700 file:text-[white] hover:file:bg-gray-500 ' required accept='video/*' onChange={(e)=>setVideoUrl(e.target.files[0])}/>
        </div>
